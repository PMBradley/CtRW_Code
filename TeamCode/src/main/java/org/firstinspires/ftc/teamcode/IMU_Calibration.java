...
public class IMU_Calibration extends LinearOpMode {
    ...
    String calFileName = "DroopyIMU.json"; // File path for the calibration data (ALWAYS include the .json)
    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a) {
                ...
                File file = AppUtil.getInstance().getSettingsFile(calFileName);
                ReadWriteFile.writeFile(file, calibrationData.serialize());
                telemetry.log().add("saved to '%s'", calFileName);
